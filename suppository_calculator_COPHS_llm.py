...
st.markdown("<h6>🗨️ Chat with an AI tutor to compute the required base using the 5-step density-ratio method.</div>", unsafe_allow_html=True)
...
st.markdown("### 🤖 LLM-Powered Explanations")

st.markdown("**Step 1: Total API amount**")
st.info("This step calculates the total weight of active pharmaceutical ingredients (APIs) in the batch. It's important because the amount of API affects how much base is displaced and how much base is needed.")

st.markdown("**Step 2: Estimated blank base**")
st.info("This is the total weight of base you'd need if there were no APIs. It gives a starting point for how much base is required before accounting for displacement.")

st.markdown("**Step 3: Density ratio or Displacement Factor**")
st.info("This step compares the density of each API to the base. A higher density means the API displaces less base. Alternatively, the Displacement Factor (DF) tells how much base is displaced by 1g of API.")

st.markdown("**Step 4: Base displaced by APIs**")
st.info("This step calculates how much base is pushed out by the APIs. It's crucial for adjusting the blank base estimate to avoid overfilling or underfilling the mold.")

st.markdown("**Step 5: Required base**")
st.info("This is the final amount of base needed after subtracting the displaced base. It ensures the suppositories have the correct weight and volume.")
