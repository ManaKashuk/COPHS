...
st.markdown("
<h1>Suppository Base Calculator</h1>", unsafe_allow_html=True)
</i></h5>🗨️Chat with an AI tutor to compute the required base using the 5-step density-ratio method.</i></h5>")
